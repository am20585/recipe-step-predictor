...
While our final model demonstrated improved performance over the baseline, the relatively modest R² suggests that there are still unexplored factors influencing recipe complexity. Exploring tags and additional data columns might offer further insights into this, and more advanced models could potentially capture the nuances in this dataset. Nevertheless, our findings show the importance of nutritional and ingredient-related features in understanding recipe complexity.
