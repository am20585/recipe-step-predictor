...
While our final model showed improved performance over the baseline, the relatively modest R² tells us that there are still unexplored factors influencing recipe complexity. Exploring tags and additional data columns might give us further insights into this, and more advanced models could potentially capture the nuances in this dataset. Nevertheless, our findings show the importance of nutritional and ingredient-related features in understanding recipe complexity.
